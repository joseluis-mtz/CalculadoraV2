Public Class Division
    ...
    Private Sub btnEjecuta_Click(sender As Object, e As EventArgs) Handles btnEjecuta.Click
        ...
        If txtNum1.Text.Length > 0 And txtNum2.Text.Length > 0 Then
            If (numero2 = 0) Then
                MsgBox("Imposible dividir entre CERO (0).", MsgBoxStyle.Critical, "ERROR CRÍTICO!")
                txtResultado.Text = "ERROR"
            Else
                Dim resultadoDiv = Val(txtNum1.Text) / Val(txtNum2.Text)
                txtResultado.Text = Math.Round(resultadoDiv, 4)
            End If
        Else
            MsgBox("Ingresa los valores por favor.", MsgBoxStyle.Information, "Ingresar datos.")
        End If
    End Sub
